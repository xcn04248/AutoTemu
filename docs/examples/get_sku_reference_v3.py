#!/usr/bin/env python3
"""
获取已有商品的 SKU 作为参考 (版本3)

使用正确的参数格式获取现有商品的 SKU 信息
"""
...
def get_sku_reference_v3():
    """获取已有商品的 SKU 作为参考"""
    print("🔍 获取已有商品的 SKU 作为参考 (版本3)")
    print("=" * 60)
                    ...
                    try:
                        ...
                        if sku_result.get("success"):
                            ...
                            if sku_list:
                                ...
                                print("-" * 40)
                                print("  🔍 重要发现:")
                                print("  1. specIdList 应该包含所有规格的 ID")
                                print("  2. 每个 SKU 的 specIdList 应该与商品级别的 specIdList 一致")
                                print("  3. 规格 ID 是整数类型")
                                print("  4. 需要先获取规格 ID，然后用于商品创建")
                                print()
